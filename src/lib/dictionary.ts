...
const en = {
  ...
  contact: {
    ...
    address: "Dr. Somani Dental Clinic, Below Lokmangal Sahakari Patsanstha, Adava Rasta, Tilak Chowk, Barshi, District Solapur, Maharashtra 413401, India",
...
const mr: TranslationDict = {
  ...
  contact: {
    ...
    address: "डॉ. सोमानी डेंटल क्लिनिक, लोकमंगल सहकारी पतसंस्थेच्या खाली, आडवा रस्ता, टिळक चौक, बार्शी, जिल्हा सोलापूर, महाराष्ट्र ४१३४०१, भारत",
